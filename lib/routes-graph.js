...
module.exports = class RoutesGraph extends Graph {
   ...
   */
  numRoutes ({ from, to, maxStops, exactStops, maxDistance, recursive, show }) {
      ...
      if (recursive) {
        ...
        if (edges)
          for (let edge of edges)
            routes += method.call(this, edge, to, condition, 0, show && [])
      } else {
        routes = method.call(this, from, to, condition, show)
